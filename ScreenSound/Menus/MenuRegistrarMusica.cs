...
internal class MenuRegistrarMusica : Menu
{
    public override void Executar(DAL<Artista> artistaDAL)
    {
        ...
        if (artistaRecuperado is not null)
        {
            ...
            Console.Write("Agora digite o album da música: ");
            string album = Console.ReadLine()!;
            artistaRecuperado.AdicionarMusica(new Musica(tituloDaMusica) { AnoLancamento = Convert.ToInt32(anoLancamento), Album = album});
